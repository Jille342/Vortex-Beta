...
public class Notification {
    ...
    public void render() {
        ...
        drawRect((int) (scaled.getScaledWidth()- offset), scaled.getScaledHeight(), - 5 - height, scaled.getScaledWidth(), scaled.getScaledHeight() - 5, color.getRGB());
        drawRect((int) (scaled.getScaledWidth() - offset), scaled.getScaledHeight(), - 5 - height, scaled.getScaledWidth()- offset + 4, scaled.getScaledHeight() - 5, color1.getRGB());

        font.drawString(title, (int) (scaled.getScaledWidth() - offset + 8), scaled.getScaledHeight()- 2 - height, -1);
        font.drawString(messsage, (int) (scaled.getScaledWidth()- offset + 8), scaled.getScaledHeight()- 15, -1);
    }
