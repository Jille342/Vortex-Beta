...
public class HUD {
	...
	public void draw() {
		...
		for(Module m : ModuleManager.modules) {
			...
			fr.drawStringWithShadow(name, sr.getScaledWidth() - fr.getStringWidth(name) - 3.5F, offset + 2.5F, 0xffffffff);
		...
		if (gui != null) {
			...
			gui.draw(k1, l1, TimerUtils.getTimer().renderPartialTicks);
		}
